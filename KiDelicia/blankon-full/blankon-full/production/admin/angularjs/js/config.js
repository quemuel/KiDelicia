                        ...
                        return $ocLazyLoad.load(
                            [
                                ...
                                },
                                {
                                    ...
                                    files: [
                                        'js/modules/sign/signin-type2.js'
                                    ]
                                }
                            ]
                        );
                        ...
                        return $ocLazyLoad.load( // you can lazy load files for an existing module
                            [
                                ...
                                },
                                {
                                    ...
                                    files: ['js/modules/pages/invoice.js']
                                }
                            ]
                        );
                    }]
                        ...
                        return $ocLazyLoad.load( // You can lazy load files for an existing module
                            [
                                ...
                                },
                                {
                                    ...
                                    files: [
                                        pluginPath+'/angular/angular-mocks.js',
                                        pluginPath+'/angular-xeditable/dist/js/xeditable.min.js',
                                        'js/modules/forms/xeditable.js'
                                    ]
                                }
                            ]
                        );
                            ...
                            [
                                {
                                    insertBefore: '#load_css_before',
                                    files: [
                                        pluginPath+'/jqvmap/jqvmap.css'
                                    ]
                                },
                                {
                                    name: 'blankonApp.maps.vector',
                                    files: [
                                        pluginPath+'/jqvmap/jquery.vmap.min.js',
                                        pluginPath+'/jqvmap/maps/jquery.vmap.world.js',
                                        pluginPath+'/jqvmap/maps/jquery.vmap.usa.js',
                                        pluginPath+'/jqvmap/maps/jquery.vmap.russia.js',
                                        pluginPath+'/jqvmap/maps/jquery.vmap.algeria.js',
                                        pluginPath+'/jqvmap/maps/jquery.vmap.germany.js',
                                        pluginPath+'/jqvmap/maps/continents/jquery.vmap.africa.js',
                                        pluginPath+'/jqvmap/maps/continents/jquery.vmap.asia.js',
                                        pluginPath+'/jqvmap/maps/continents/jquery.vmap.australia.js',
                                        pluginPath+'/jqvmap/maps/continents/jquery.vmap.europe.js',
                                        pluginPath+'/jqvmap/maps/continents/jquery.vmap.north-america.js',
                                        pluginPath+'/jqvmap/maps/continents/jquery.vmap.south-america.js',
                                        pluginPath+'/jqvmap/data/jquery.vmap.sampledata.js',
                                        'js/modules/maps/map-vector.js'
                                    ]
                                }
                            ]
                        );
                            ...
                            [
                                {
                                    insertBefore: '#load_css_before',
                                    files: [
                                        pluginPath+'/morrisjs/morris.min.js'
                                    ]
                                },
                                {
                            ...
                            [
                                {
                                    ...
                                    files: [
                                        pluginPath+'/chartjs/Chart.min.js',
                                        'js/modules/charts/chartjs.js'
                                    ]
                                },
                                {
