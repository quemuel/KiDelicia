...
use app\assets\admin\blankon\BlankonAsset;

BlankonAsset::register($this);

$this->title = 'BLANKON VERSIONS | BLANKON - Fullpack Admin Theme';
...
<section id="page-content">
    ...
    <div class="body-content animated fadeIn">
        ...
        <div class="row mt-20 mb-20">
            <div class="col-xs-12 col-sm-3 col-md-3">
                <div class="text-center">
                    <a href="../../../../production/admin/html/dashboard.html" target="_blank"><img src="<?= \Yii::getAlias('@asset') ?>/admin/img/version/html-version.png" alt="html version"/></a>
                </div>
            </div>
            <div class="col-xs-12 col-sm-9 col-md-9">
                ...
                <a href="../../../../production/admin/html/dashboard.html" class="btn btn-success" target="_blank">Let's See</a>
        ...
        <div class="row mb-20">
            <div class="col-xs-12 col-sm-3 col-md-3">
                <div class="text-center">
                    <a href="../../angularjs/#/dashboard" target="_blank"><img src="<?= \Yii::getAlias('@asset') ?>/admin/img/version/angularjs-version.png" alt="angularjs version"/></a>
                </div>
            </div>
            <div class="col-xs-12 col-sm-9 col-md-9">
        ...
        <div class="row mb-20">
            <div class="col-xs-12 col-sm-3 col-md-3">
                <div class="text-center">
                    <a href="#"><img src="<?= \Yii::getAlias('@asset') ?>/admin/img/version/yii-version.png" alt="yii version"/></a>
                </div>
            </div>
            <div class="col-xs-12 col-sm-9 col-md-9">
        ...
        <div class="row mt-20 mb-20">
            <div class="col-xs-12 col-sm-3 col-md-3">
                <div class="text-center">
                    <a href="../../laravel/public/dashboard/index" target="_blank"><img src="<?= \Yii::getAlias('@asset') ?>/admin/img/version/laravel-version.png" alt="laravel version"/></a>
                </div>
            </div>
            <div class="col-xs-12 col-sm-9 col-md-9">
        ...
        <div class="row mb-20">
            <div class="col-xs-12 col-sm-3 col-md-3">
                <div class="text-center">
                    <a href="#" target="_blank"><img src="<?= \Yii::getAlias('@asset') ?>/admin/img/version/ajax-version.png" alt="ajax version"/></a>
                </div>
            </div>
            <div class="col-xs-12 col-sm-9 col-md-9">
        ...
        <div class="row mb-20">
            <div class="col-xs-12 col-sm-3 col-md-3">
                <div class="text-center">
                    <a href="#" target="_blank"><img src="<?= \Yii::getAlias('@asset') ?>/admin/img/version/php-version.png" alt="php version"/></a>
                </div>
            </div>
            <div class="col-xs-12 col-sm-9 col-md-9">
                <h4>PHP Version <span class="label label-success hidden-xs">AVAILABLE</span></h4>
                <p>
                ...
                <a href="../../php/index.php" class="btn btn-success" target="_blank">Let's See</a>
        ...
        <div class="row mb-20">
            <div class="col-xs-12 col-sm-3 col-md-3">
                <div class="text-center">
                    <a href="#" target="_blank"><img src="<?= \Yii::getAlias('@asset') ?>/admin/img/version/codeigniter-version.png" alt="codeigniter version"/></a>
                </div>
            </div>
            <div class="col-xs-12 col-sm-9 col-md-9">
                <h4>Codeigniter Framework Version <span class="label label-danger hidden-xs">NEW</span></h4>
                <p>
                ...
                <a href="https://ellislab.com/codeigniter hidden-xs" class="btn btn-primary hidden-xs" target="_blank">Official Website</a>
            </div>
        </div>
