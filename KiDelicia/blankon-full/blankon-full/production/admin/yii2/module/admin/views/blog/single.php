            ...
            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                ...
                <div class="panel panel-default panel-blog rounded shadow">
                    <div class="panel-body">
                        ...
                        <div class="blog-img"><img src="<?= \Yii::getAlias('@asset') ?>/global/img/uncategorized/2.jpg" class="img-responsive" alt="..."></div>
                ...
                <div class="blog-author">
                    <div class="media">
                        <a class="pull-left" href="#">
                            <img class="media-object thumbnail" src="<?= \Yii::getAlias('@asset') ?>/global/img/avatar/100/1.png" alt="...">
                        </a>
                ...
                <ul class="media-list comment-list">
                    ...
                    <li class="media">
                        <a class="pull-left" href="#">
                            <img class="media-object thumbnail" src="<?= \Yii::getAlias('@asset') ?>/global/img/avatar/50/10.png" alt="...">
                        </a>
                        <div class="media-body">
                    ...
                    <li class="media">
                        <a class="pull-left" href="#">
                            <img class="media-object thumbnail" src="<?= \Yii::getAlias('@asset') ?>/global/img/avatar/50/11.png" alt="...">
                        </a>
                        <div class="media-body">
                            <a href="#" class="btn btn-success btn-xs pull-right rounded">Reply</a>
                            ...
                            <div class="media">
                                <a class="pull-left" href="#">
                                    <img class="media-object thumbnail" src="<?= \Yii::getAlias('@asset') ?>/global/img/avatar/50/12.png" alt="...">
                                </a>
                                <div class="media-body">
                                    <a href="#" class="btn btn-success btn-xs pull-right rounded">Reply</a>
                                    <h4>Harry Potret</h4>
                    ...
                    <li class="media">
                        <a class="pull-left" href="#">
                            <img class="media-object thumbnail" src="<?= \Yii::getAlias('@asset') ?>/global/img/avatar/50/13.png" alt="...">
                        </a>
                        <div class="media-body">
                            <a href="#" class="btn btn-success btn-xs pull-right rounded">Reply</a>
                            <h4>Claudia Cinta</h4>
                            ...
                            <div class="media">
                                <a class="pull-left" href="#">
                                    <img class="media-object thumbnail" src="<?= \Yii::getAlias('@asset') ?>/global/img/avatar/50/14.png" alt="...">
                                </a>
                                <div class="media-body">
                                    <a href="#" class="btn btn-success btn-xs pull-right rounded">Reply</a>
                                    <h4>Daniel Miring</h4>
                                    ...
                                    <div class="media">
                                        <a class="pull-left" href="#">
                                            <img class="media-object thumbnail" src="<?= \Yii::getAlias('@asset') ?>/global/img/avatar/50/15.png" alt="...">
                                        </a>
                                        <div class="media-body">
                                            <a href="#" class="btn btn-success btn-xs pull-right rounded">Reply</a>
                                            <h4>Jeck Joko</h4>
                            ...
                            <div class="media">
                                <a class="pull-left" href="#">
                                    <img class="media-object thumbnail" src="<?= \Yii::getAlias('@asset') ?>/global/img/avatar/50/16.png" alt="...">
                                </a>
                                <div class="media-body">
                                    <a href="#" class="btn btn-success btn-xs pull-right rounded">Reply</a>
                                    <h4>Tenny Imoet</h4>
                        ...
                        <div class="panel-body no-padding transparent">
                            <div class="blog-gallery">
                                <ul class="list-inline">
                                    <li>
                                        <a href="#"><img src="<?= \Yii::getAlias('@asset') ?>/global/img/realistic/64/1.jpg" alt="..."/></a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="<?= \Yii::getAlias('@asset') ?>/global/img/realistic/64/2.jpg" alt="..."/></a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="<?= \Yii::getAlias('@asset') ?>/global/img/realistic/64/3.jpg" alt="..."/></a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="<?= \Yii::getAlias('@asset') ?>/global/img/realistic/64/4.jpg" alt="..."/></a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="<?= \Yii::getAlias('@asset') ?>/global/img/realistic/64/5.jpg" alt="..."/></a>
                                    </li>
                                    <li>
                                        <a href="#"><img src="<?= \Yii::getAlias('@asset') ?>/global/img/realistic/64/6.jpg" alt="..."/></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="item">
                                    <div class="blog-list">
                                        <div class="media">
                                            <a class="pull-left" href="#">
                                                <img src="<?= \Yii::getAlias('@asset') ?>/global/img/animals/2.jpg" alt="..." class="img-responsive img-thumbnail"/>
                                            </a>
                                            <div class="media-body">
                                        ...
                                        <div class="media">
                                            <a class="pull-left" href="#">
                                                <img src="<?= \Yii::getAlias('@asset') ?>/global/img/animals/3.jpg" alt="..." class="img-responsive img-thumbnail"/>
                                            </a>
                                            <div class="media-body">
