                        ...
                        <div class="inner-cover">
                            ...
                            <div class="btn-group cover-menu-mobile hidden-lg hidden-md">
                                ...
                                <ul class="dropdown-menu pull-right no-border" role="menu">
                                    <li class="active"><a href="<?= Yii::$app->getUrlManager()->createUrl('admin/page/timeline') ?>"><i class="fa fa-fw fa-clock-o"></i> <span>Timeline</span></a></li>
                            ...
                            <img src="<?= \Yii::getAlias('@asset') ?>/global/img/building/6.jpg" class="img-responsive full-width" alt="cover">
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="panel rounded shadow">
                            ...
                            <div class="panel-body no-padding text-center">
                                <img src="<?= \Yii::getAlias('@asset') ?>/global/img/food/1.jpg" alt="..." class="img-responsive br-t-3 full-width"/>
                        ...
                        <div class="panel panel-success rounded shadow">
                            ...
                            <div class="panel-body no-padding">
                                <img src="<?= \Yii::getAlias('@asset') ?>/global/img/realistic/8.jpg" alt="..." class="img-responsive full-width"/>
