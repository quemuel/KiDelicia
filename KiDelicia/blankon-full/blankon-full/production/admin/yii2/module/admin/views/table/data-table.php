                                                ...
                                                <div class="repeater-header-right">
                                                    <div class="btn-group selectlist repeater-filters" data-resize="auto">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                            ...
                                                            <li data-value="collectible_art"><a href="#">Collectible & art</a></li>
                                                            <li data-value="electronics"><a href="#">Electronics</a></li>
                                                            <li data-value="entertainment"><a href="#">Entertainment</a></li>
                                                            <li data-value="fashion"><a href="#">Fashion</a></li>
                                                            <li data-value="home_garden"><a href="#">Home & garden</a></li>
                                                            <li data-value="motors"><a href="#">Motors</a></li>
                                                            <li data-value="sporting_goods"><a href="#">Sporting goods</a></li>
                                                            <li data-value="toys_hobbies"><a href="#">Toys & hobbies</a></li>
                                                            <li data-value="other_categories"><a href="#">Other categories</a></li>
                                                        </ul>
                            ...
                            <div class="panel rounded shadow">
                                ...
                                <div class="panel-body">
                                    ...
                                    <table id="datatable-dom" class="table table-striped table-lilac">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="text-center" style="width: 1%"><img src="<?= \Yii::getAlias('@asset') ?>/global/img/realistic/4.jpg" alt="..." width="160" class="mt-5 mb-5"/></td>
                                            ...
                                            <tr>
                                                <td class="text-center" style="width: 1%"><img src="<?= \Yii::getAlias('@asset') ?>/global/img/realistic/2.jpg" alt="..." width="160" class="mt-5 mb-5"/></td>
                                            ...
                                            <tr>
                                                <td class="text-center" style="width: 1%"><img src="<?= \Yii::getAlias('@asset') ?>/global/img/realistic/1.jpg" alt="..." width="160" class="mt-5 mb-5"/></td>
                                                <td>Code Quality</td>
                                            ...
                                            <tr>
                                                <td class="text-center" style="width: 1%"><img src="<?= \Yii::getAlias('@asset') ?>/global/img/realistic/5.jpg" alt="..." width="160" class="mt-5 mb-5"/></td>
                                            ...
                                            <tr>
                                                <td class="text-center" style="width: 1%"><img src="<?= \Yii::getAlias('@asset') ?>/global/img/realistic/8.jpg" alt="..." width="160" class="mt-5 mb-5"/></td>
                                            ...
                                            <tr>
                                                <td class="text-center" style="width: 1%"><img src="<?= \Yii::getAlias('@asset') ?>/global/img/realistic/3.jpg" alt="..." width="160" class="mt-5 mb-5"/></td>
                                                <td>5 Icon Types</td>
                                            ...
                                            <tr>
                                                <td class="text-center" style="width: 1%"><img src="<?= \Yii::getAlias('@asset') ?>/global/img/realistic/6.jpg" alt="..." width="160" class="mt-5 mb-5"/></td>
                                            ...
                                            <tr>
                                                <td class="text-center" style="width: 1%"><img src="<?= \Yii::getAlias('@asset') ?>/global/img/realistic/7.jpg" alt="..." width="160" class="mt-5 mb-5"/></td>
