...
$this->title = 'TABLE DEFAULT | BLANKON - Fullpack Admin Theme';
?>
    ...
    <div class="body-content animated fadeIn">
                    ...
                    <table class="table table-striped table-success">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <img src="<?= \Yii::getAlias('@asset') ?>/global/img/avatar/35/2.png" class="img-circle img-bordered-theme" alt="John Kribo">
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="<?= \Yii::getAlias('@asset') ?>/global/img/avatar/35/3.png" class="img-circle img-bordered-theme" alt="Jennifer Poiyem">
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="<?= \Yii::getAlias('@asset') ?>/global/img/avatar/35/4.png" class="img-circle img-bordered-theme" alt="Clara Wati">
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="<?= \Yii::getAlias('@asset') ?>/global/img/avatar/35/5.png" class="img-circle img-bordered-theme" alt="Toni Mriang">
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="<?= \Yii::getAlias('@asset') ?>/global/img/avatar/35/6.png" class="img-circle img-bordered-theme" alt="Bella negoro">
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="<?= \Yii::getAlias('@asset') ?>/global/img/avatar/35/7.png" class="img-circle img-bordered-theme" alt="Kim Mbako">
                                    <span>Kim Mbako</span>
                                </td>
                                <td>Angola</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="<?= \Yii::getAlias('@asset') ?>/global/img/avatar/35/8.png" class="img-circle img-bordered-theme" alt="Pack Suparman">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h4 class="no-margin">Contextual classes row <span class="label label-danger">NEW</span></h4>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h4 class="no-margin">Contextual classes column <span class="label label-danger">NEW</span></h4>
