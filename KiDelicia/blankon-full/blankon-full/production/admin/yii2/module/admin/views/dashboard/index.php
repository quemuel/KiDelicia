...
$this->title = "DASHBOARD | BLANKON - Fullpack Admin Theme";
?>
    ...
    <div class="body-content animated fadeIn">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-4 col-xs-12">
                        ...
                        <div class="widget-wrapper bg-theme rounded">
                            <div class="weather-current-city">
                                <img src="<?= \Yii::getAlias('@asset'); ?>/global/img/building/5.jpg" alt="..."/>
                                <div class="row">
        ...
        <div class="row">
            <div class="col-md-9">
                ...
                <!-- Start dropzone js -->
                <form action="<?= \Yii::getAlias('@asset'); ?>/admin/data" class="dropzone mb-20 rounded">
                    <div class="fallback">
