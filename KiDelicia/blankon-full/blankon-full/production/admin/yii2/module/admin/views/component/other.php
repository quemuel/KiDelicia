                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-md-4">
                                <div class="thumbnail">
                                    <img src="<?= \Yii::getAlias('@asset') ?>/global/img/realistic/4.jpg" alt="..." class="img-responsive"/>
                                    <div class="caption">
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="thumbnail">
                                    <img src="<?= \Yii::getAlias('@asset') ?>/global/img/realistic/5.jpg" alt="..." class="img-responsive"/>
                                    <div class="caption">
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="thumbnail">
                                    <img src="<?= \Yii::getAlias('@asset') ?>/global/img/realistic/6.jpg" alt="..." class="img-responsive"/>
                                    <div class="caption">
                        ...
                        <div class="panel rounded shadow">
                            <div class="panel-body">
                                ...
                                <div>
                                    ...
                                    <img class="mr-15" src="<?= \Yii::getAlias('@asset') ?>/global/img/loader/general/1.gif" alt="..."/>
                                    <img class="mr-15" src="<?= \Yii::getAlias('@asset') ?>/global/img/loader/general/2.gif" alt="..."/>
                                    <img class="mr-15" src="<?= \Yii::getAlias('@asset') ?>/global/img/loader/general/3.gif" alt="..."/>
                                    <img class="mr-15" src="<?= \Yii::getAlias('@asset') ?>/global/img/loader/general/4.gif" alt="..."/>
                                    <img class="mr-15" src="<?= \Yii::getAlias('@asset') ?>/global/img/loader/general/5.gif" alt="..."/>
                                    <img class="mr-15" src="<?= \Yii::getAlias('@asset') ?>/global/img/loader/general/6.gif" alt="..."/>
                                    <img class="mr-15" src="<?= \Yii::getAlias('@asset') ?>/global/img/loader/general/7.gif" alt="..."/>
                                    <img class="mr-15" src="<?= \Yii::getAlias('@asset') ?>/global/img/loader/general/8.gif" alt="..."/>
                                    <img class="mr-15" src="<?= \Yii::getAlias('@asset') ?>/global/img/loader/general/9.gif" alt="..."/>
                                    <img class="mr-15" src="<?= \Yii::getAlias('@asset') ?>/global/img/loader/general/10.gif" alt="..."/>
                                </div>
                                <div></div>
                        ...
                        <div class="panel rounded shadow">
                            <div class="panel-body">
                                ...
                                <div>
                                    ...
                                    <img class="mr-15" src="<?= \Yii::getAlias('@asset') ?>/global/img/loader/flat/1.gif" width="20" alt="..."/>
                                    <img class="mr-15" src="<?= \Yii::getAlias('@asset') ?>/global/img/loader/flat/2.gif" width="20" alt="..."/>
                                    <img class="mr-15" src="<?= \Yii::getAlias('@asset') ?>/global/img/loader/flat/3.gif" width="20" alt="..."/>
                                    <img class="mr-15" src="<?= \Yii::getAlias('@asset') ?>/global/img/loader/flat/4.gif" width="20" alt="..."/>
                                    <img class="mr-15" src="<?= \Yii::getAlias('@asset') ?>/global/img/loader/flat/5.gif" width="20" alt="..."/>
                                    <img class="mr-15" src="<?= \Yii::getAlias('@asset') ?>/global/img/loader/flat/6.gif" width="20" alt="..."/>
                                    <img class="mr-15" src="<?= \Yii::getAlias('@asset') ?>/global/img/loader/flat/7.gif" width="20" alt="..."/>
                                </div>
                                <div></div>
