...
$this->title = "BLOG GRID | BLANKON - Fullpack Admin Theme";
        ...
        <div id="blog-grid" class="row">
            ...
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                <div class="blog-item rounded shadow">
                    <a href="<?= Yii::$app->getUrlManager()->createUrl('admin/blog/single') ?>" class="blog-img"><img src="<?= \Yii::getAlias('@asset') ?>/global/img/nature/1.jpg" class="img-responsive full-width" alt="..." /></a>
                    <div class="blog-details">
                        ...
                        <div class="blog-summary">
                            ...
                            <a href="<?= Yii::$app->getUrlManager()->createUrl('admin/blog/single') ?>" class="btn btn-sm btn-success">Read More</a>
                        </div>
                    </div>
                </div><!-- /.blog-item -->
            </div><!-- col-md-3 -->
            ...
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                <div class="blog-item blog-quote rounded shadow">
                    <div class="quote quote-primary">
                        <a href="<?= Yii::$app->getUrlManager()->createUrl('admin/blog/single') ?>">
            ...
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                <div class="blog-item rounded shadow">
                    <a href="<?= Yii::$app->getUrlManager()->createUrl('admin/blog/single') ?>" class="blog-img"><img src="<?= \Yii::getAlias('@asset') ?>/global/img/people/2.jpg" class="img-responsive" alt="..." /></a>
                    <div class="blog-details">
            ...
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                <div class="blog-item rounded shadow">
                    <div id="carousel-blog-post" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img src="<?= \Yii::getAlias('@asset') ?>/global/img/nature/2.jpg" class="img-responsive" alt="..." />
                                <div class="carousel-caption">
                                    I am
                                </div>
                            </div>
                            <div class="item">
                                <img src="<?= \Yii::getAlias('@asset') ?>/global/img/nature/5.jpg" class="img-responsive" alt="..." />
                                <div class="carousel-caption">
                                    Be Happy :D
                                </div>
                            </div>
                    ...
                    <div class="blog-details">
                        <h4 class="blog-title"><a href="<?= Yii::$app->getUrlManager()->createUrl('admin/blog/single') ?>">This is my Way! Don't stop me</a></h4>
                        <ul class="blog-meta">
                            <li>By: <a href="http://djavaui.com/" target="_blank">Djava UI</a></li>
                            <li>Jun 08, 2014</li>
            ...
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                <div class="blog-item rounded shadow">
                    ...
                    <div class="blog-details">
                        <h4 class="blog-title"><a href="<?= Yii::$app->getUrlManager()->createUrl('admin/blog/single') ?>">New Zealand, Nature Landscapes</a></h4>
                        <ul class="blog-meta">
                            <li>By: <a href="http://djavaui.com/" target="_blank">Djava UI</a></li>
                            <li>Jun 08, 2014</li>
            ...
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                <div class="blog-item rounded shadow">
                    <a href="<?= Yii::$app->getUrlManager()->createUrl('admin/blog/single') ?>" class="blog-img"><img src="<?= \Yii::getAlias('@asset') ?>/global/img/technology/3.jpg" class="img-responsive" alt="..." /></a>
                    <div class="blog-details">
            ...
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                <div class="blog-item rounded shadow">
                    <a href="<?= Yii::$app->getUrlManager()->createUrl('admin/blog/single') ?>" class="blog-img"><img src="<?= \Yii::getAlias('@asset') ?>/global/img/realistic/4.jpg" class="img-responsive" alt="..." /></a>
                    <div class="blog-details">
            ...
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                <div class="blog-item rounded shadow">
                    <a href="<?= Yii::$app->getUrlManager()->createUrl('admin/blog/single') ?>" class="blog-img"><img src="<?= \Yii::getAlias('@asset') ?>/global/img/technology/4.jpg" class="img-responsive" alt="..." /></a>
                    <div class="blog-details">
            ...
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                <div class="blog-item rounded shadow">
                    <a href="<?= Yii::$app->getUrlManager()->createUrl('admin/blog/single') ?>" class="blog-img"><img src="<?= \Yii::getAlias('@asset') ?>/global/img/realistic/7.jpg" class="img-responsive" alt="..." /></a>
                    <div class="blog-details">
            ...
            <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                <div class="blog-item rounded shadow">
                    <a href="<?= Yii::$app->getUrlManager()->createUrl('admin/blog/single') ?>" class="blog-img"><img src="<?= \Yii::getAlias('@asset') ?>/global/img/technology/5.jpg" class="img-responsive" alt="..." /></a>
                    <div class="blog-details">
                        <div class="ribbon-wrapper">
