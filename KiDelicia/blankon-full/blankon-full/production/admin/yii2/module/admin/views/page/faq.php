...
use app\assets\admin\page\FaqAsset;

FaqAsset::register($this);

$this->title = "FAQ | BLANKON - Fullpack Admin Theme";
...
<section id="page-content">
    ...
    <div class="cbp-item buyer">
        <div class="cbp-caption">
            <div class="cbp-caption-defaultWrap">
                <i class="fa fa-user fa-5x"></i> How to redownload items you ordered?
            </div>
    ...
    <div class="cbp-item seller">
        <div class="cbp-caption">
            <div class="cbp-caption-defaultWrap">
                <i class="fa fa-user-secret fa-5x"></i> Can sellers make more money by selling an item here exclusively?
            </div>
            <div class="cbp-caption-activeWrap">
                <div class="cbp-l-caption-body">
    ...
    <div class="cbp-item affiliate">
        <div class="cbp-caption">
            <div class="cbp-caption-defaultWrap">
                <i class="fa fa-user-plus fa-5x"></i> How much can affiliates earn?
            </div>
            <div class="cbp-caption-activeWrap">
                <div class="cbp-l-caption-body">
    ...
    <div class="cbp-item affiliate">
        <div class="cbp-caption">
            <div class="cbp-caption-defaultWrap">
                <i class="fa fa-user-plus fa-5x"></i> How do affiliates get paid?
            </div>
            <div class="cbp-caption-activeWrap">
                <div class="cbp-l-caption-body">
    ...
    <div class="cbp-item buyer">
        <div class="cbp-caption">
            <div class="cbp-caption-defaultWrap">
                <i class="fa fa-user fa-5x"></i> How to create invoices for your orders?
            </div>
            <div class="cbp-caption-activeWrap">
                <div class="cbp-l-caption-body">
    ...
    <div class="cbp-item seller">
        <div class="cbp-caption">
            <div class="cbp-caption-defaultWrap">
                <i class="fa fa-user-secret fa-5x"></i> Is exclusivity based on the author or the individual file?
            </div>
            <div class="cbp-caption-activeWrap">
                <div class="cbp-l-caption-body">
    ...
    <div class="cbp-item seller">
        <div class="cbp-caption">
            <div class="cbp-caption-defaultWrap">
                <i class="fa fa-user-secret fa-5x"></i> Do sellers retain rights to the items they sell on WrapBootstrap?
            </div>
            <div class="cbp-caption-activeWrap">
                <div class="cbp-l-caption-body">
    ...
    <div class="cbp-item buyer">
        <div class="cbp-caption">
            <div class="cbp-caption-defaultWrap">
                <i class="fa fa-user fa-5x"></i> How to attach orders to your account?
            </div>
            <div class="cbp-caption-activeWrap">
                <div class="cbp-l-caption-body">
    ...
    <div class="cbp-item affiliate">
        <div class="cbp-caption">
            <div class="cbp-caption-defaultWrap">
                <i class="fa fa-user-plus fa-5x"></i> How long do affiliate cookies last?
            </div>
            <div class="cbp-caption-activeWrap">
                <div class="cbp-l-caption-body">
    ...
    <div class="cbp-item seller">
        <div class="cbp-caption">
            <div class="cbp-caption-defaultWrap">
                <i class="fa fa-user-secret fa-5x"></i> Are items reviewed or will you accept anything?
            </div>
            <div class="cbp-caption-activeWrap">
                <div class="cbp-l-caption-body">
    ...
    <div class="cbp-item affiliate">
        <div class="cbp-caption">
            <div class="cbp-caption-defaultWrap">
                <i class="fa fa-user-plus fa-5x"></i> Can I advertise on search engines using WrapBootstrap-related keywords?
            </div>
            <div class="cbp-caption-activeWrap">
                <div class="cbp-l-caption-body">
    ...
    <div class="cbp-item seller">
        <div class="cbp-caption">
            <div class="cbp-caption-defaultWrap">
                <i class="fa fa-user-secret fa-5x"></i> How do sellers get paid?
            </div>
            <div class="cbp-caption-activeWrap">
                <div class="cbp-l-caption-body">
    ...
    <div class="cbp-item affiliate">
        <div class="cbp-caption">
            <div class="cbp-caption-defaultWrap">
                <i class="fa fa-user-plus fa-5x"></i> Can I receive earnings from items that I purchase with my affiliate link?
            </div>
            <div class="cbp-caption-activeWrap">
                <div class="cbp-l-caption-body">
    ...
    <div class="cbp-item seller">
        <div class="cbp-caption">
            <div class="cbp-caption-defaultWrap">
                <i class="fa fa-user-secret fa-5x"></i> Are sellers required to support the items they upload?
            </div>
            <div class="cbp-caption-activeWrap">
                <div class="cbp-l-caption-body">
