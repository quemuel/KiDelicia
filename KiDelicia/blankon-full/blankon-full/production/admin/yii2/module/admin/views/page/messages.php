...
use app\assets\admin\page\MessagesAsset;
...
<section id="page-content">
    ...
    <div class="header-content">
        <h2><i class="fa fa-comments"></i> Messages <span>messages sample</span></h2>
        ...
        <div class="row message-wrapper rounded shadow mb-20">
            ...
            <div class="col-md-8 message-sideright">
                <div class="panel">
                    <div class="panel-heading">
                        <div class="media">
                            <a href="<?= Yii::$app->getUrlManager()->createUrl('admin/mail/compose') ?>" class="btn btn-danger pull-right rounded"><i class="fa fa-share"></i></a>
                            <a class="pull-left" href="#">
                                <img src="<?= \Yii::getAlias('@asset') ?>/global/img/avatar/50/18.png" alt="Rebecca Cabean" class="img-circle"/>
                            </a>
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <div class="media">
                            <a class="pull-left" href="#">
                                <img src="<?= \Yii::getAlias('@asset') ?>/global/img/avatar/50/11.png" alt="sarah tingting" class="img-circle"/>
                            </a>
                            <div class="media-body">
