                                    ...
                                    <ul class="sidebar-menu niceScroll">
                                        ...
                                        <li>
                                            <div class="media-list working">
                                                <a href="#" class="media">
                                                    <div class="media-object pull-left has-notif">
                                                        <img src="<?= \Yii::getAlias('@asset') ?>/global/img/avatar/35/10.png" class="img-circle" alt="Daddy Botak">
                                                        <i class="online"></i>
                                                    </div><!-- /.media-object -->
                                                    <div class="media-body">
                                                ...
                                                <a href="#" class="media">
                                                    <div class="media-object pull-left has-notif">
                                                        <img src="<?= \Yii::getAlias('@asset') ?>/global/img/avatar/35/11.png" class="img-circle" alt="Sarah Tingting">
                                                        <i class="offline"></i>
                                                    </div><!-- /.media-object -->
                                                    <div class="media-body">
                                                ...
                                                <a href="#" class="media">
                                                    <div class="media-object pull-left has-notif">
                                                        <img src="<?= \Yii::getAlias('@asset') ?>/global/img/avatar/35/26.png" class="img-circle" alt="">
                                                        <i class="busy"></i>
                                                    </div><!-- /.media-object -->
                                                    <div class="media-body">
                                                ...
                                                <a href="#" class="media">
                                                    <div class="media-object pull-left has-notif">
                                                        <img src="<?= \Yii::getAlias('@asset') ?>/global/img/avatar/35/13.png" class="img-circle" alt="Claudia Cinta">
                                                        <i class="online"></i>
                                                    </div><!-- /.media-object -->
                                                    <div class="media-body">
                                    ...
                                    <ul class="sidebar-menu niceScroll">
                                        ...
                                        <li>
                                            ...
                                            <div class="media-list">
                                                ...
                                                <a href="#" class="media">
                                                    <span class="media-object pull-left has-notif">
                                                        <img src="<?= \Yii::getAlias('@asset') ?>/global/img/avatar/35/12.png" class="img-circle" alt="Harry Potret">
                                                        <i class="online"></i>
                                                    </span>
                                                    <span class="media-body">
                                        ...
                                        <li>
                                            ...
                                            <div class="media-list">
                                                <a href="#" class="media">
                                                    <span class="media-object pull-left has-notif">
                                                        <img src="<?= \Yii::getAlias('@asset') ?>/global/img/avatar/35/15.png" class="img-circle" alt="Jeck Joko">
                                                        <i class="online"></i>
                                                    </span>
                                                    <span class="media-body">
                                                ...
                                                <a href="#" class="media">
                                                    <span class="media-object pull-left has-notif">
                                                        <img src="<?= \Yii::getAlias('@asset') ?>/global/img/avatar/35/16.png" class="img-circle" alt="Tenny Imoet">
                                                        <i class="busy"></i>
                                                    </span>
                                                    <span class="media-body">
                                                ...
                                                <a href="#" class="media">
                                                    <span class="media-object pull-left has-notif">
                                                        <img src="<?= \Yii::getAlias('@asset') ?>/global/img/avatar/35/17.png" class="img-circle" alt="Leli Madang">
                                                        <i class="offline"></i>
                                                    </span>
                                                    <span class="media-body">
                                                ...
                                                <a href="#" class="media">
                                                    <span class="media-object pull-left has-notif">
                                                        <img src="<?= \Yii::getAlias('@asset') ?>/global/img/avatar/35/18.png" class="img-circle" alt="Rebecca Cabean">
                                                        <i class="offline"></i>
                                                    </span>
                                                    <span class="media-body">
                                        ...
                                        <li>
                                            ...
                                            <div class="media-list">
                                                <a href="#" class="media">
                                                    <span class="media-object pull-left has-notif">
                                                        <img src="<?= \Yii::getAlias('@asset') ?>/global/img/avatar/35/19.png" class="img-circle" alt="Sishy Mawar">
                                                        <i class="offline"></i>
                                                    </span>
                                                    <span class="media-body">
                                                ...
                                                <a href="#" class="media">
                                                    <span class="media-object pull-left has-notif">
                                                        <img src="<?= \Yii::getAlias('@asset') ?>/global/img/avatar/35/20.png" class="img-circle" alt="Mbah Roso">
                                                        <i class="away"></i>
                                                    </span>
                                                    <span class="media-body">
