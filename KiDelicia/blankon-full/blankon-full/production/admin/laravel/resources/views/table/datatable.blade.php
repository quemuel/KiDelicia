                ...
                <div class="panel rounded shadow">
                    ...
                    <div class="panel-body">
                        ...
                        <table id="datatable-dom" class="table table-striped table-lilac">
                            ...
                            <tbody>
                                <tr>
                                    <td class="text-center" style="width: 1%"><img src="{{$assetUrl}}global/img/realistic/4.jpg" alt="..." width="160" class="mt-5 mb-5"/></td>
                                ...
                                <tr>
                                    <td class="text-center" style="width: 1%"><img src="{{$assetUrl}}global/img/realistic/2.jpg" alt="..." width="160" class="mt-5 mb-5"/></td>
                                ...
                                <tr>
                                    <td class="text-center" style="width: 1%"><img src="{{$assetUrl}}global/img/realistic/1.jpg" alt="..." width="160" class="mt-5 mb-5"/></td>
                                    <td>Code Quality</td>
                                ...
                                <tr>
                                    <td class="text-center" style="width: 1%"><img src="{{$assetUrl}}global/img/realistic/5.jpg" alt="..." width="160" class="mt-5 mb-5"/></td>
                                ...
                                <tr>
                                    <td class="text-center" style="width: 1%"><img src="{{$assetUrl}}global/img/realistic/8.jpg" alt="..." width="160" class="mt-5 mb-5"/></td>
                                ...
                                <tr>
                                    <td class="text-center" style="width: 1%"><img src="{{$assetUrl}}global/img/realistic/3.jpg" alt="..." width="160" class="mt-5 mb-5"/></td>
                                    <td>5 Icon Types</td>
                                ...
                                <tr>
                                    <td class="text-center" style="width: 1%"><img src="{{$assetUrl}}global/img/realistic/6.jpg" alt="..." width="160" class="mt-5 mb-5"/></td>
                                ...
                                <tr>
                                    <td class="text-center" style="width: 1%"><img src="{{$assetUrl}}global/img/realistic/7.jpg" alt="..." width="160" class="mt-5 mb-5"/></td>
