                ...
                <div class="profile-cover">
                    <div class="cover rounded shadow no-overflow">
                        <div class="inner-cover">
                            ...
                            <img src="{{$assetUrl}}global/img/building/6.jpg" class="img-responsive full-width" alt="cover">
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="panel rounded shadow">
                            ...
                            <div class="panel-body no-padding text-center">
                                <img src="{{$assetUrl}}global/img/food/1.jpg" alt="..." class="img-responsive br-t-3 full-width"/>
                        ...
                        <div class="panel panel-success rounded shadow">
                            ...
                            <div class="panel-body no-padding">
                                <img src="{{$assetUrl}}global/img/realistic/8.jpg" alt="..." class="img-responsive full-width"/>
