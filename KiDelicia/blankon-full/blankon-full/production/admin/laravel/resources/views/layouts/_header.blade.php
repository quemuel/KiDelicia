    ...
    <div class="header-left">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{url('dashboard/index')}}">
                <img class="logo" src="{{$assetUrl}}global/img/logo/laravel/logo-white.png" alt="brand logo"/>
            </a><!-- /.navbar-brand -->
            <!--/ End brand -->
                        ...
                        <div class="dropdown-body">
                            ...
                            <div class="media-list niceScroll">
                                ...
                                <a href="{{url('page/messages')}}" class="media">
                                    <div class="pull-left"><img src="{{$assetUrl}}global/img/avatar/50/2.png" class="media-object img-circle" alt="John Kribo"/></div>
                                ...
                                <a href="{{url('page/messages')}}" class="media">
                                    <div class="pull-left"><img src="{{$assetUrl}}global/img/avatar/50/3.png" class="media-object img-circle" alt="Jennifer Poiyem"/></div>
                                    <div class="media-body">
                                ...
                                <a href="{{url('page/messages')}}" class="media">
                                    <div class="pull-left"><img src="{{$assetUrl}}global/img/avatar/50/4.png" class="media-object img-circle" alt="Clara Wati"/></div>
                                    <div class="media-body">
                                ...
                                <a href="{{url('page/messages')}}" class="media">
                                    <div class="pull-left"><img src="{{$assetUrl}}global/img/avatar/50/5.png" class="media-object img-circle" alt="Toni Mriang"/></div>
                                    <div class="media-body">
                                ...
                                <a href="{{url('page/messages')}}" class="media">
                                    <div class="pull-left"><img src="{{$assetUrl}}global/img/avatar/50/6.png" class="media-object img-circle" alt="Bella negoro"/></div>
                                    <div class="media-body">
                                ...
                                <a href="{{url('page/messages')}}" class="media">
                                    <div class="pull-left"><img src="{{$assetUrl}}global/img/avatar/50/7.png" class="media-object img-circle" alt="Kim Mbako"/></div>
                                    <div class="media-body">
                                ...
                                <a href="{{url('page/messages')}}" class="media">
                                    <div class="pull-left"><img src="{{$assetUrl}}global/img/avatar/50/8.png" class="media-object img-circle" alt="Pack Suparman"/></div>
                                    <div class="media-body">
                    ...
                    <div class="dropdown-menu animated flipInX">
                        ...
                        <div class="dropdown-body niceScroll">
                            ...
                            <div class="media-list small">
                                ...
                                <a href="#" class="media">
                                    <div class="media-object pull-left"><img class="img-circle" src="{{$assetUrl}}global/img/avatar/50/10.png" alt=""/></div>
                                    <div class="media-body">
