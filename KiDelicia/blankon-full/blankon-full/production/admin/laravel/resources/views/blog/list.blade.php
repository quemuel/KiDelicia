            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="blog-item rounded shadow">
                        <a href="{{url('blog/single')}}" class="blog-img"><img src="{{$assetUrl}}global/img/nature/1.jpg" class="img-responsive full-width" alt="..." /></a>
                        <div class="blog-details">
                            ...
                            <div class="blog-summary">
                                ...
                                <a href="{{url('blog/single')}}" class="btn btn-sm btn-success">Read More</a>
                            </div>
                        </div>
                    </div><!-- /.blog-item -->
                    ...
                    <div class="blog-item rounded shadow">
                        <a href="{{url('blog/single')}}" class="blog-img"><img src="{{$assetUrl}}global/img/people/2.jpg" class="img-responsive" alt="..." /></a>
                        <div class="blog-details">
                    ...
                    <div class="blog-item rounded shadow">
                        <div id="carousel-blog-post" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img src="{{$assetUrl}}global/img/nature/2.jpg" class="img-responsive" alt="..." />
                                    <div class="carousel-caption">
                                        I am
                                    </div>
                                </div>
                                <div class="item">
                                    <img src="{{$assetUrl}}global/img/nature/5.jpg" class="img-responsive" alt="..." />
                                    <div class="carousel-caption">
                                        Be Happy :D
                                    </div>
                                </div>
                        ...
                        <div class="blog-details">
                            <h4 class="blog-title"><a href="{{url('blog/single')}}">This is my Way! Don't stop me</a></h4>
                            <ul class="blog-meta">
                                <li>By: <a href="http://djavaui.com/" target="_blank">Djava UI</a></li>
                                <li>Jun 08, 2014</li>
                    ...
                    <div class="blog-item rounded shadow" style="height: 218px;">
                        ...
                        <div class="blog-details">
                            <h4 class="blog-title"><a href="{{url('blog/single')}}">New Zealand, Nature Landscapes</a></h4>
                            <ul class="blog-meta">
                                <li>By: <a href="http://djavaui.com/" target="_blank">Djava UI</a></li>
                                <li>Jun 08, 2014</li>
                    ...
                    <div class="blog-item rounded shadow">
                        <a href="{{url('blog/single')}}" class="blog-img"><img src="{{$assetUrl}}global/img/technology/3.jpg" class="img-responsive" alt="..." /></a>
                        <div class="blog-details">
                    ...
                    <div class="blog-item rounded shadow">
                        <a href="{{url('blog/single')}}" class="blog-img"><img src="{{$assetUrl}}global/img/realistic/4.jpg" class="img-responsive" alt="..." /></a>
                        <div class="blog-details">
                    ...
                    <div class="blog-item rounded shadow">
                        <a href="{{url('blog/single')}}" class="blog-img"><img src="{{$assetUrl}}global/img/technology/4.jpg" class="img-responsive" alt="..." /></a>
                        <div class="blog-details">
                    ...
                    <div class="blog-item rounded shadow">
                        <a href="{{url('blog/single')}}" class="blog-img"><img src="{{$assetUrl}}global/img/realistic/7.jpg" class="img-responsive" alt="..." /></a>
                        <div class="blog-details">
                    ...
                    <div class="blog-item rounded shadow">
                        <a href="{{url('blog/single')}}" class="blog-img"><img src="{{$assetUrl}}global/img/technology/5.jpg" class="img-responsive" alt="..." /></a>
                        <div class="blog-details">
                            <div class="ribbon-wrapper">
