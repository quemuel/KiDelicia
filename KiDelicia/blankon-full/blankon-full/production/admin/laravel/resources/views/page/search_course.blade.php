                ...
                <div class="media-list list-search">
                    <div class="media rounded shadow no-overflow">
                        <div class="media-left">
                            <a href="#">
                                ...
                                <img src="{{$assetUrl}}global/img/technology/1.jpg" class="img-responsive media-object" alt="..."/>
                            </a>
                        </div>
                    ...
                    <div class="media rounded shadow no-overflow selected">
                        ...
                        <div class="media-left">
                            <a href="#">
                                ...
                                <img src="{{$assetUrl}}global/img/technology/2.jpg" class="img-responsive media-object" alt="..."/>
                            </a>
                        </div>
                        <div class="media-body">
                    ...
                    <div class="media rounded shadow no-overflow">
                        <div class="media-left">
                            <a href="#">
                                ...
                                <img src="{{$assetUrl}}global/img/technology/3.jpg" class="img-responsive media-object" alt="..."/>
                            </a>
                        </div>
                        <div class="media-body">
                    ...
                    <div class="media rounded shadow no-overflow">
                        <div class="media-left">
                            <a href="#">
                                ...
                                <img src="{{$assetUrl}}global/img/technology/4.jpg" class="img-responsive media-object" alt="..."/>
                            </a>
                        </div>
                        <div class="media-body">
                    ...
                    <div class="media rounded shadow no-overflow">
                        <div class="media-left">
                            <a href="#">
                                <span class="meta-provider warning">LYNDA</span>
                                <img src="{{$assetUrl}}global/img/uncategorized/1.jpg" class="img-responsive media-object" alt="..."/>
                            </a>
                        </div>
                        <div class="media-body">
                    ...
                    <div class="media rounded shadow no-overflow">
                        ...
                        <div class="media-left">
                            <a href="#">
                                <span class="meta-provider danger">SKILLSHARE</span>
                                <img src="{{$assetUrl}}global/img/technology/5.jpg" class="img-responsive media-object" alt="..."/>
                            </a>
                        </div>
                        <div class="media-body">
                    ...
                    <div class="media rounded shadow no-overflow">
                        <div class="media-left">
                            <a href="#">
                                ...
                                <img src="{{$assetUrl}}global/img/uncategorized/3.jpg" class="img-responsive media-object" alt="..."/>
                            </a>
                        </div>
                        <div class="media-body">
                    ...
                    <div class="media rounded shadow no-overflow">
                        <div class="media-left">
                            <a href="#">
                                ...
                                <img src="{{$assetUrl}}global/img/people/4.jpg" class="img-responsive media-object" alt="..."/>
                            </a>
                        </div>
                        <div class="media-body">
                    ...
                    <div class="media rounded shadow no-overflow">
                        <div class="media-left">
                            <a href="#">
                                ...
                                <img src="{{$assetUrl}}global/img/animals/1.jpg" class="img-responsive media-object" alt="..."/>
                            </a>
                        </div>
                        <div class="media-body">
