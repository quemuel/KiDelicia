...
<section id="page-content">
    ...
    <div class="body-content animated fadeIn">
        ...
        <div class="row">
            <div class="col-sm-3">
                <a href="{{url('mail/compose')}}" class="btn btn-danger btn-block btn-compose-email rounded">Compose Email</a>
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="media">
                                                <a href="#" class="pull-left">
                                                    <img alt="..." src="{{$assetUrl}}global/img/avatar/35/2.png" class="media-object">
                                                </a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="media">
                                                <a href="#" class="pull-left">
                                                    <img alt="..." src="{{$assetUrl}}global/img/avatar/35/3.png" class="media-object">
                                                </a>
                                                <div class="media-body">
                                    ...
                                    <tr class="unread">
                                        ...
                                        <td>
                                            <div class="media">
                                                <a href="#" class="pull-left">
                                                    <img alt="..." src="{{$assetUrl}}global/img/avatar/35/4.png" class="media-object">
                                                </a>
                                                <div class="media-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="media">
                                                <a href="#" class="pull-left">
                                                    <img alt="..." src="{{$assetUrl}}global/img/avatar/35/5.png" class="media-object">
                                                </a>
                                                <div class="media-body">
                                    ...
                                    <tr class="selected">
                                        ...
                                        <td>
                                            <div class="media">
                                                <a href="#" class="pull-left">
                                                    <img alt="..." src="{{$assetUrl}}global/img/avatar/35/6.png" class="media-object">
                                                </a>
                                                <div class="media-body">
                                    ...
                                    <tr class="unread">
                                        ...
                                        <td>
                                            <div class="media">
                                                <a href="#" class="pull-left">
                                                    <img alt="..." src="{{$assetUrl}}global/img/avatar/35/7.png" class="media-object">
                                                </a>
                                                <div class="media-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="media">
                                                <a href="#" class="pull-left">
                                                    <img alt="..." src="{{$assetUrl}}global/img/avatar/35/8.png" class="media-object">
                                                </a>
                                                <div class="media-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="media">
                                                <a href="#" class="pull-left">
                                                    <img alt="..." src="{{$assetUrl}}global/img/avatar/35/9.png" class="media-object">
                                                </a>
                                                <div class="media-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="media">
                                                <a href="#" class="pull-left">
                                                    <img alt="..." src="{{$assetUrl}}global/img/avatar/35/10.png" class="media-object">
                                                </a>
                                                <div class="media-body">
                                    ...
                                    <tr class="unread">
                                        ...
                                        <td>
                                            <div class="media">
                                                <a href="#" class="pull-left">
                                                    <img alt="..." src="{{$assetUrl}}global/img/avatar/35/11.png" class="media-object">
                                                </a>
                                                <div class="media-body">
