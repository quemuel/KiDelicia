...
<div class="header-left">
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="dashboard.html">
            <img class="logo" src="{url}assets/global/img/logo/php/logo-white.png" alt="brand logo"/>
        </a><!-- /.navbar-brand -->
        <!--/ End brand -->
        ...
        <div class="dropdown-body">
            ...
            <div class="media-list niceScroll">
                ...
                <a href="page-messages.html" class="media">
                    <div class="pull-left"><img src="{url}assets/global/img/avatar/50/2.png" class="media-object img-circle" alt="John Kribo"/></div>
                ...
                <a href="page-messages.html" class="media">
                    <div class="pull-left"><img src="{url}assets/global/img/avatar/50/3.png" class="media-object img-circle" alt="Jennifer Poiyem"/></div>
                    <div class="media-body">
                ...
                <a href="page-messages.html" class="media">
                    <div class="pull-left"><img src="{url}assets/global/img/avatar/50/4.png" class="media-object img-circle" alt="Clara Wati"/></div>
                    <div class="media-body">
                ...
                <a href="page-messages.html" class="media">
                    <div class="pull-left"><img src="{url}assets/global/img/avatar/50/5.png" class="media-object img-circle" alt="Toni Mriang"/></div>
                    <div class="media-body">
                ...
                <a href="page-messages.html" class="media">
                    <div class="pull-left"><img src="{url}assets/global/img/avatar/50/6.png" class="media-object img-circle" alt="Bella negoro"/></div>
                    <div class="media-body">
                ...
                <a href="page-messages.html" class="media">
                    <div class="pull-left"><img src="{url}assets/global/img/avatar/50/7.png" class="media-object img-circle" alt="Kim Mbako"/></div>
                    <div class="media-body">
                ...
                <a href="page-messages.html" class="media">
                    <div class="pull-left"><img src="{url}assets/global/img/avatar/50/8.png" class="media-object img-circle" alt="Pack Suparman"/></div>
                    <div class="media-body">
    ...
    <div class="dropdown-menu animated flipInX">
        ...
        <div class="dropdown-body niceScroll">
            ...
            <div class="media-list small">
                ...
                <a href="#" class="media">
                    <div class="media-object pull-left"><img class="img-circle" src="{url}assets/global/img/avatar/50/10.png" alt=""/></div>
                    <div class="media-body">
...
<li class="dropdown navbar-profile">
    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <span class="meta">
                                    <span class="avatar"><img src="{url}assets/global/img/avatar/35/1.png" class="img-circle" alt="admin"></span>
    ...
    <ul class="dropdown-menu animated flipInX">
        ...
        <li class="divider"></li>
        <li><a href="{url}production/admin/php/index.php?v=page-signin"><i class="fa fa-sign-out"></i>Logout</a></li>
    </ul>
    <!--/ End dropdown menu -->
