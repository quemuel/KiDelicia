...
<div class="header-content">
    <h2><i class="fa fa-dropbox"></i>{page}<span>{info}</span></h2>
    <div class="breadcrumb-wrapper hidden-xs">
        <span class="label">You are here:</span>
        <ol class="breadcrumb">
            <li>
                <i class="fa fa-home"></i>
                <a href="{url}admin/php/index.php">Dashboard</a>
...
<div class="body-content animated fadeIn">
    ...
    <div class="row mt-20 mb-20">
        <div class="col-xs-12 col-sm-3 col-md-3">
            <div class="text-center">
                <a href="../html/dashboard.html"><img src="{url}assets/admin/img/version/html-version.png" alt="html version"/></a>
            </div>
        </div>
        <div class="col-xs-12 col-sm-9 col-md-9">
            <h4>HTML Version <span class="label label-success">AVAILABLE</span></h4>
            <p>
            ...
            <a href="../html/dashboard.html" class="btn btn-success" target="_blank">Let's See</a>
    ...
    <div class="row mb-20">
        <div class="col-xs-12 col-sm-3 col-md-3">
            <div class="text-center">
                <a href="../angularjs/#/dashboard" target="_blank"><img src="{url}assets/admin/img/version/angularjs-version.png" alt="angularjs version"/></a>
            </div>
        </div>
        <div class="col-xs-12 col-sm-9 col-md-9">
            <h4>AngularJS Version <span class="label label-success">AVAILABLE</span></h4>
            <p>
            ...
            <a href="../angularjs/#/dashboard" class="btn btn-success" target="_blank">Let's See</a>
            <a href="http://en.wikipedia.org/wiki/AngularJS" class="btn btn-warning" target="_blank">Readmore</a>
            <a href="https://angularjs.org/" class="btn btn-primary" target="_blank">Official Website</a>
        </div>
    </div>
    <div class="row mb-20">
        <div class="col-xs-12 col-sm-3 col-md-3">
            <div class="text-center">
                <a href="../yii2/web/index.php?r=admin%2Fdashboard%2Findex" target="_blank"><img src="{url}assets/admin/img/version/yii-version.png" alt="yii version"/></a>
            </div>
        </div>
        <div class="col-xs-12 col-sm-9 col-md-9">
            <h4>Yii Framework Version <span class="label label-success">AVAILABLE</span></h4>
            <p>
            ...
            <a href="../yii2/web/index.php?r=admin%2Fdashboard%2Findex" class="btn btn-success" target="_blank">Let's See</a>
            <a href="http://en.wikipedia.org/wiki/Yii" class="btn btn-warning" target="_blank">Readmore</a>
            <a href="http://www.yiiframework.com/" class="btn btn-primary" target="_blank">Official Website</a>
        </div>
    </div>
    <div class="row mt-20 mb-20">
        <div class="col-xs-12 col-sm-3 col-md-3">
            <div class="text-center">
                <a href="../laravel/public/dashboard/index" target="_blank"><img src="{url}assets/admin/img/version/laravel-version.png" alt="laravel version"/></a>
            </div>
        </div>
        <div class="col-xs-12 col-sm-9 col-md-9">
            <h4>Laravel Framework Version <span class="label label-success">AVAILABLE</span></h4>
            <p>
                Laravel is a web application framework with expressive, elegant syntax. We believe development must be an enjoyable, creative experience to be truly fulfilling. Laravel attempts to take the pain out of development by easing common tasks used in the majority of web projects, such as authentication, routing, sessions, and caching.
            </p>
            <a href="../laravel/public/dashboard/index" class="btn btn-success" target="_blank">Let's See</a>
            <a href="http://en.wikipedia.org/wiki/Laravel" class="btn btn-warning" target="_blank">Readmore</a>
            <a href="http://laravel.com/" class="btn btn-primary" target="_blank">Official Website</a>
        </div>
    </div>
    <div class="row mb-20">
        <div class="col-xs-12 col-sm-3 col-md-3">
            <div class="text-center">
                <a href="../ajax/#dashboard" target="_blank"><img src="{url}assets/admin/img/version/ajax-version.png" alt="ajax version"/></a>
            </div>
        </div>
        <div class="col-xs-12 col-sm-9 col-md-9">
            <h4>AJAX Version <span class="label label-success">AVAILABLE</span></h4>
            <p>
            ...
            <a href="../ajax/#dashboard" class="btn btn-success" target="_blank">Let's See</a>
    ...
    <div class="row mb-20">
        <div class="col-xs-12 col-sm-3 col-md-3">
            <div class="text-center">
                <a href="#" target="_blank"><img src="{url}assets/admin/img/version/php-version.png" alt="php version"/></a>
            </div>
        </div>
        <div class="col-xs-12 col-sm-9 col-md-9">
            ...
            <a href="http://php.net/" class="btn btn-primary" target="_blank">Official Website</a>
        </div>
    </div>
    <div class="row mb-20">
        <div class="col-xs-12 col-sm-3 col-md-3">
            <div class="text-center">
                <a href="#" target="_blank"><img src="{url}assets/admin/img/version/codeigniter-version.png" alt="codeigniter version"/></a>
            </div>
        </div>
        <div class="col-xs-12 col-sm-9 col-md-9">
            <h4>Codeigniter Framework Version <span class="label label-danger">NEW</span></h4>
            <p>
            ...
            <a href="../codeigniter/index.php" class="btn btn-success" target="_blank">Let's See</a>
            <a href="http://en.wikipedia.org/wiki/CodeIgniter" class="btn btn-warning" target="_blank">Readmore</a>
            <a href="https://ellislab.com/codeigniter" class="btn btn-primary" target="_blank">Official Website</a>
        </div>
    </div>
