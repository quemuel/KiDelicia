...
<div class="header-content">
    <h2><i class="fa fa-inbox"></i> {page} <span>{info}</span></h2>
...
<div class="row">
<div class="col-sm-3">
    <a href="mail-compose.html" class="btn btn-danger btn-block btn-compose-email rounded">Compose Email</a>
...
<tr>
    ...
    <td>
        <div class="media">
            <a href="#" class="pull-left">
                <img alt="..." src="../../../assets/global/img/avatar/35/3.png" class="media-object">
            </a>
            <div class="media-body">
...
<tr class="unread">
    ...
    <td>
        <div class="media">
            <a href="#" class="pull-left">
                <img alt="..." src="../../../assets/global/img/avatar/35/4.png" class="media-object">
            </a>
            <div class="media-body">
...
<tr>
    ...
    <td>
        <div class="media">
            <a href="#" class="pull-left">
                <img alt="..." src="../../../assets/global/img/avatar/35/5.png" class="media-object">
            </a>
            <div class="media-body">
...
<tr class="selected">
    ...
    <td>
        <div class="media">
            <a href="#" class="pull-left">
                <img alt="..." src="../../../assets/global/img/avatar/35/6.png" class="media-object">
            </a>
            <div class="media-body">
...
<tr class="unread">
    ...
    <td>
        <div class="media">
            <a href="#" class="pull-left">
                <img alt="..." src="../../../assets/global/img/avatar/35/7.png" class="media-object">
            </a>
            <div class="media-body">
...
<tr>
    ...
    <td>
        <div class="media">
            <a href="#" class="pull-left">
                <img alt="..." src="../../../assets/global/img/avatar/35/8.png" class="media-object">
            </a>
            <div class="media-body">
...
<tr>
    ...
    <td>
        <div class="media">
            <a href="#" class="pull-left">
                <img alt="..." src="../../../assets/global/img/avatar/35/9.png" class="media-object">
            </a>
            <div class="media-body">
...
<tr>
    ...
    <td>
        <div class="media">
            <a href="#" class="pull-left">
                <img alt="..." src="../../../assets/global/img/avatar/35/10.png" class="media-object">
            </a>
            <div class="media-body">
...
<tr class="unread">
    ...
    <td>
        <div class="media">
            <a href="#" class="pull-left">
                <img alt="..." src="../../../assets/global/img/avatar/35/11.png" class="media-object">
            </a>
            <div class="media-body">
