...
<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
    <div class="blog-item rounded shadow">
        <a href="blog-single.html" class="blog-img"><img src="{url}assets/global/img/nature/1.jpg" class="img-responsive full-width" alt="..." /></a>
...
<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
    <div class="blog-item rounded shadow">
        <a href="blog-single.html" class="blog-img"><img src="{url}assets/global/img/people/2.jpg" class="img-responsive" alt="..." /></a>
        <div class="blog-details">
        ...
        <div id="carousel-blog-post" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item active">
                    <img src="{url}assets/global/img/nature/2.jpg" class="img-responsive" alt="..." />
                    <div class="carousel-caption">
                        I am
                    </div>
                </div>
                <div class="item">
                    <img src="{url}assets/global/img/nature/5.jpg" class="img-responsive" alt="..." />
                    <div class="carousel-caption">
                        Be Happy :D
                    </div>
                </div>
...
<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
    <div class="blog-item rounded shadow">
        <a href="blog-single.html" class="blog-img"><img src="{url}assets/global/img/technology/3.jpg" class="img-responsive" alt="..." /></a>
        <div class="blog-details">
...
<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
    <div class="blog-item rounded shadow">
        <a href="blog-single.html" class="blog-img"><img src="{url}assets/global/img/realistic/4.jpg" class="img-responsive" alt="..." /></a>
        <div class="blog-details">
...
<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
    <div class="blog-item rounded shadow">
        <a href="blog-single.html" class="blog-img"><img src="{url}assets/global/img/technology/4.jpg" class="img-responsive" alt="..." /></a>
        <div class="blog-details">
...
<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
    <div class="blog-item rounded shadow">
        <a href="blog-single.html" class="blog-img"><img src="{url}assets/global/img/realistic/7.jpg" class="img-responsive" alt="..." /></a>
        <div class="blog-details">
...
<div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
    <div class="blog-item rounded shadow">
        <a href="blog-single.html" class="blog-img"><img src="{url}assets/global/img/technology/5.jpg" class="img-responsive" alt="..." /></a>
        <div class="blog-details">
            <div class="ribbon-wrapper">
