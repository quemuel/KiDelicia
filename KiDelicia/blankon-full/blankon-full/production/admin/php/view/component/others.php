...
<div class="header-content">
    <h2><i class="fa fa-slack"></i> {page}<span>{info}</span></h2>
    ...
    <div class="panel-body">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="../../../assets/global/img/realistic/4.jpg" alt="..." class="img-responsive"/>
                    <div class="caption">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="../../../assets/global/img/realistic/5.jpg" alt="..." class="img-responsive"/>
                    <div class="caption">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="../../../assets/global/img/realistic/6.jpg" alt="..." class="img-responsive"/>
                    <div class="caption">
