...
<div id="sign-wrapper">
    ...
    <!-- Brand -->
    <div class="brand">
        <img src="{url}assets/global/img/logo/php/logo-vertical.png" alt="brand logo"/>
    </div>
    <!--/ Brand -->

    <!-- Login form -->
    <form class="sign-in form-horizontal shadow rounded no-overflow" action="{url}production/admin/php/index.php" method="post">
    ...
    <!-- Content text -->
    <p class="text-muted text-center sign-link">Need an account? <a href="{url}production/admin/php/index.php?v=page-signup"> Sign up free</a></p>
    <!--/ Content text -->
