...
<div class="header-content">
    <h2><i class="fa fa-male"></i> {page} <span>{info}</span></h2>
...
<div class="profile-cover">
    <div class="cover rounded shadow no-overflow">
        <div class="inner-cover">
            ...
            <img src="{url}assets/global/img/building/6.jpg" class="img-responsive full-width" alt="cover">
        </div>
    ...
    <div class="col-md-6">
        <div class="panel rounded shadow">
            <div class="media corner-left half bg-overlay rounded">
                <div class="media-object pull-left">
                    <img src="{url}assets/global/img/avatar/35/1.png" alt="..." class="img-circle"/>
                </div>
            ...
            <div class="panel-body no-padding text-center">
                <img src="{url}assets/global/img/food/1.jpg" alt="..." class="img-responsive br-t-3 full-width"/>
            ...
            <div class="panel-footer">
                <div class="pull-left">
                    ...
                    <img src="{url}assets/global/img/avatar/35/10.png" alt="..." class="img-circle"/>
                    <img src="{url}assets/global/img/avatar/35/11.png" alt="..." class="img-circle"/>
                    <img src="{url}assets/global/img/avatar/35/12.png" alt="..." class="img-circle"/>
                    <img src="{url}assets/global/img/avatar/35/13.png" alt="..." class="img-circle"/>
                </div>
                <div class="clearfix"></div>
            </div><!-- /.panel-footer -->
        </div><!-- /.panel -->
        <div class="panel panel-success rounded shadow">
            ...
            <div class="panel-body no-padding">
                <img src="{url}assets/global/img/realistic/8.jpg" alt="..." class="img-responsive full-width"/>
                ...
                <div class="media inner-all no-margin">
                    <div class="pull-left">
                        <img src="{url}assets/global/img/avatar/50/15.png" alt="..."/>
                    </div><!-- /.pull-left -->
                    <div class="media-body">
                ...
                <div class="media inner-all no-margin">
                    <div class="pull-left">
                        <img src="{url}assets/global/img/avatar/50/16.png" alt="..."/>
                    </div><!-- /.pull-left -->
                    <div class="media-body">
        ...
        <div class="panel panel-success rounded shadow">
            ...
            <div class="panel-body no-padding">
                <div class="inner-all block">
                    ...
                    <img class="mb-5" src="{url}assets/global/img/food/2.jpg" alt="..." width="100"/>
                    <img class="mb-5" src="{url}assets/global/img/food/3.jpg" alt="..." width="100"/>
                    <img src="{url}assets/global/img/food/4.jpg" alt="..." width="100"/>
                </div><!-- /.inner-all -->
