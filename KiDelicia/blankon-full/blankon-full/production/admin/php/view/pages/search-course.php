    ...
    <div class="media-list list-search">
        <div class="media rounded shadow no-overflow">
            <div class="media-left">
                <a href="#">
                    ...
                    <img src="../../../assets/global/img/technology/1.jpg" class="img-responsive media-object" alt="..."/>
                </a>
            </div>
        ...
        <div class="media rounded shadow no-overflow selected">
            ...
            <div class="media-left">
                <a href="#">
                    ...
                    <img src="../../../assets/global/img/technology/2.jpg" class="img-responsive media-object" alt="..."/>
                </a>
            </div>
            <div class="media-body">
        ...
        <div class="media rounded shadow no-overflow">
            <div class="media-left">
                <a href="#">
                    ...
                    <img src="../../../assets/global/img/technology/3.jpg" class="img-responsive media-object" alt="..."/>
                </a>
            </div>
            <div class="media-body">
        ...
        <div class="media rounded shadow no-overflow">
            <div class="media-left">
                <a href="#">
                    ...
                    <img src="../../../assets/global/img/technology/4.jpg" class="img-responsive media-object" alt="..."/>
                </a>
            </div>
            <div class="media-body">
        ...
        <div class="media rounded shadow no-overflow">
            <div class="media-left">
                <a href="#">
                    <span class="meta-provider warning">LYNDA</span>
                    <img src="../../../assets/global/img/uncategorized/1.jpg" class="img-responsive media-object" alt="..."/>
                </a>
            </div>
            <div class="media-body">
        ...
        <div class="media rounded shadow no-overflow">
            ...
            <div class="media-left">
                <a href="#">
                    <span class="meta-provider danger">SKILLSHARE</span>
                    <img src="../../../assets/global/img/technology/5.jpg" class="img-responsive media-object" alt="..."/>
                </a>
            </div>
            <div class="media-body">
        ...
        <div class="media rounded shadow no-overflow">
            <div class="media-left">
                <a href="#">
                    ...
                    <img src="../../../assets/global/img/uncategorized/3.jpg" class="img-responsive media-object" alt="..."/>
                </a>
            </div>
            <div class="media-body">
        ...
        <div class="media rounded shadow no-overflow">
            <div class="media-left">
                <a href="#">
                    ...
                    <img src="../../../assets/global/img/people/4.jpg" class="img-responsive media-object" alt="..."/>
                </a>
            </div>
            <div class="media-body">
        ...
        <div class="media rounded shadow no-overflow">
            <div class="media-left">
                <a href="#">
                    ...
                    <img src="../../../assets/global/img/animals/1.jpg" class="img-responsive media-object" alt="..."/>
                </a>
            </div>
            <div class="media-body">
        ...
        <p class="text-center"><img src="../../../assets/global/img/loader/general/2.gif" alt="..."> Load more courses</p>
    </div>
</div>
</div><!-- /.row -->
