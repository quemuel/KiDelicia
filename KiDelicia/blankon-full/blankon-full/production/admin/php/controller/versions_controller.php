...
class version_controller {
    ...
    public function runIndex(){
        ...
        $library = Array(
            'title'         =>'BLANKON VERSIONS | BLANKON - Fullpack Admin Theme',
            ...
            'page'          =>'Blankon Versions ', //this title to breadcrumb
            'info'          =>'All within bundle', //this info of breadcrumb
            ...
            'levelScript'   =>' <script src="'.$pathAdmin.'apps.js"></script
                            ...
                            ',
            'menuVersions' =>'class="active"',
            'selectVersions'=>'class="selected"',
        ...
        $template = file_get_contents('view/layout.php');
                ...
                $content= file_get_contents('view/versions-content.php');
